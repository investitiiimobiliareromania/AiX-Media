...
export const institutionalDossiers: InstitutionalCompanyDossier[] = [
  // 1. BANCA TRANSILVANIA (TLV)
  {
    ...
    logo: '/fallbacks/story-1.jpg',
    coverImage: '/fallbacks/story-1.jpg',
  ...
  // 2. HIDROELECTRICA (H2O)
  {
    ...
    logo: '/fallbacks/story-2.jpg',
    coverImage: '/fallbacks/story-2.jpg',
  ...
  // 3. OMV PETROM (SNP)
  {
    ...
    logo: '/fallbacks/story-3.jpg',
    coverImage: '/fallbacks/story-3.jpg',
