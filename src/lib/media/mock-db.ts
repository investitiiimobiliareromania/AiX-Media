...
export const marketItems: MarketItem[] = [
  { symbol: "BET", name: "Bucharest Exchange Trading", value: "18,420.50", changeDaily: "+2.30%", changeWeekly: "+3.8%", changeMonthly: "+6.1%", changeYearly: "+24.5%", isPositive: true, category: "indices", status: "OPEN", chartPoints: [18000, 18120, 18250, 18380, 18420], source: "BVB", date: "2026-08-05" },
  { symbol: "BET-TR", name: "BET Total Return Index", value: "39,850.10", changeDaily: "+2.45%", changeWeekly: "+4.1%", changeMonthly: "+7.2%", changeYearly: "+28.2%", isPositive: true, category: "indices", status: "OPEN", chartPoints: [38500, 39000, 39400, 39850], source: "BVB", date: "2026-08-05" },
  { symbol: "BET-FI", name: "BET Financial Investment", value: "62,140.00", changeDaily: "+1.15%", changeWeekly: "+2.2%", changeMonthly: "+4.5%", changeYearly: "+18.9%", isPositive: true, category: "indices", status: "OPEN", chartPoints: [61000, 61500, 62140], source: "BVB", date: "2026-08-05" },
  { symbol: "BET-NG", name: "BET Energy & Utilities", value: "1,240.80", changeDaily: "+0.85%", changeWeekly: "+1.9%", changeMonthly: "+3.8%", changeYearly: "+19.4%", isPositive: true, category: "indices", status: "OPEN", chartPoints: [1200, 1220, 1240], source: "BVB", date: "2026-08-05" },
  { symbol: "EUR/RON", name: "Euro / Romanian Leu", value: "4.9765", changeDaily: "+0.02%", changeWeekly: "-0.01%", changeMonthly: "+0.15%", changeYearly: "+0.85%", isPositive: true, category: "currencies", status: "OPEN", source: "BNR", date: "2026-08-05" },
  { symbol: "USD/RON", name: "US Dollar / Romanian Leu", value: "4.5830", changeDaily: "-0.11%", changeWeekly: "-0.45%", changeMonthly: "-1.20%", changeYearly: "-2.10%", isPositive: false, category: "currencies", status: "OPEN", source: "BNR", date: "2026-08-05" },
  { symbol: "GBP/RON", name: "British Pound / Leu", value: "5.8240", changeDaily: "+0.14%", changeWeekly: "+0.50%", changeMonthly: "+0.90%", changeYearly: "+3.20%", isPositive: true, category: "currencies", status: "OPEN", source: "BNR", date: "2026-08-05" },
  { symbol: "CHF/RON", name: "Swiss Franc / Leu", value: "5.2110", changeDaily: "+0.08%", changeWeekly: "+0.22%", changeMonthly: "+0.60%", changeYearly: "+2.40%", isPositive: true, category: "currencies", status: "OPEN", source: "BNR", date: "2026-08-05" },
  { symbol: "ROBOR 3M", name: "Interbank Rate 3M", value: "5.58%", changeDaily: "-0.05%", changeWeekly: "-0.12%", changeMonthly: "-0.30%", changeYearly: "-1.10%", isPositive: true, category: "rates", status: "OPEN", source: "BNR", date: "2026-08-05" },
  { symbol: "ROBOR 6M", name: "Interbank Rate 6M", value: "5.64%", changeDaily: "-0.04%", changeWeekly: "-0.10%", changeMonthly: "-0.28%", changeYearly: "-1.05%", isPositive: true, category: "rates", status: "OPEN", source: "BNR", date: "2026-08-05" },
  { symbol: "IRCC", name: "Consumer Credit Benchmark", value: "5.86%", changeDaily: "-0.11%", changeWeekly: "-0.11%", changeMonthly: "-0.11%", changeYearly: "-0.45%", isPositive: true, category: "rates", status: "OPEN", source: "BNR", date: "2026-08-05" },
  { symbol: "BNR RATE", name: "National Bank Key Rate", value: "6.50%", changeDaily: "0.00%", changeWeekly: "0.00%", changeMonthly: "0.00%", changeYearly: "-0.50%", isPositive: true, category: "rates", status: "OPEN", source: "BNR", date: "2026-08-05" },
  { symbol: "RO 10Y BOND", name: "Romanian Govt 10Y Bond", value: "6.42%", changeDaily: "-0.08%", changeWeekly: "-0.15%", changeMonthly: "-0.40%", changeYearly: "-1.20%", isPositive: true, category: "bonds", status: "OPEN", source: "BNR", date: "2026-08-05" },
  { symbol: "CPI INFLATION", name: "Romania Annual CPI", value: "5.10%", changeDaily: "-0.40%", changeWeekly: "-0.40%", changeMonthly: "-0.80%", changeYearly: "-3.20%", isPositive: true, category: "rates", status: "OPEN", source: "INS", date: "2026-08-05" },
  { symbol: "XAU/USD", name: "Gold Spot", value: "$2,348.40", changeDaily: "+0.60%", changeWeekly: "+1.8%", changeMonthly: "+4.2%", changeYearly: "+19.8%", isPositive: true, category: "commodities", status: "OPEN", source: "LBMA", date: "2026-08-05" },
  { symbol: "XAG/USD", name: "Silver Spot", value: "$27.43", changeDaily: "+1.10%", changeWeekly: "+3.2%", changeMonthly: "+6.5%", changeYearly: "+22.4%", isPositive: true, category: "commodities", status: "OPEN", source: "LBMA", date: "2026-08-05" },
  { symbol: "BRENT", name: "Brent Crude Oil", value: "$84.72", changeDaily: "-1.20%", changeWeekly: "-2.4%", changeMonthly: "-4.1%", changeYearly: "-8.5%", isPositive: false, category: "commodities", status: "OPEN", source: "ICE", date: "2026-08-05" },
  { symbol: "NG", name: "Natural Gas (TTF)", value: "€34.20", changeDaily: "+0.45%", changeWeekly: "+1.1%", changeMonthly: "+3.0%", changeYearly: "-12.0%", isPositive: true, category: "commodities", status: "OPEN", source: "ICE", date: "2026-08-05" },
  { symbol: "BTC/USD", name: "Bitcoin", value: "$64,250", changeDaily: "+3.10%", changeWeekly: "+8.4%", changeMonthly: "+14.2%", changeYearly: "+112.5%", isPositive: true, category: "crypto", status: "OPEN", source: "Coinbase", date: "2026-08-05" },
  { symbol: "ETH/USD", name: "Ethereum", value: "$3,480", changeDaily: "+2.40%", changeWeekly: "+6.1%", changeMonthly: "+11.8%", changeYearly: "+84.2%", isPositive: true, category: "crypto", status: "OPEN", source: "Coinbase", date: "2026-08-05" },
  { symbol: "S&P 500", name: "S&P 500 Index", value: "5,611.80", changeDaily: "+0.80%", changeWeekly: "+1.5%", changeMonthly: "+3.2%", changeYearly: "+21.4%", isPositive: true, category: "global", status: "OPEN", source: "S&P Dow Jones", date: "2026-08-05" },
  { symbol: "NASDAQ", name: "NASDAQ Composite", value: "17,890.40", changeDaily: "+1.20%", changeWeekly: "+2.4%", changeMonthly: "+4.8%", changeYearly: "+28.9%", isPositive: true, category: "global", status: "OPEN", source: "Nasdaq", date: "2026-08-05" },
  { symbol: "DAX", name: "DAX Performance Index", value: "18,890.30", changeDaily: "-0.40%", changeWeekly: "+0.2%", changeMonthly: "+1.8%", changeYearly: "+14.2%", isPositive: false, category: "global", status: "OPEN", source: "Deutsche Börse", date: "2026-08-05" },
];
