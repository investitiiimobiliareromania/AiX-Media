    ...
    <section className="bg-foreground text-background pt-32 pb-16 md:pt-40 md:pb-24 border-b border-border transition-colors duration-300" aria-labelledby="category-hero-title">
      <div className="container mx-auto px-4 md:px-6">
        <header className="max-w-4xl">
          {label && (
            <div className="mb-8 inline-flex items-center gap-2 border border-white/30 px-3 py-1 bg-[var(--surface-elevated)]/10 text-xs font-bold uppercase tracking-widest text-white/80">
              <span className="w-2 h-2 bg-[var(--surface-elevated)] rounded-full" />
              {label}
            </div>
          )}
