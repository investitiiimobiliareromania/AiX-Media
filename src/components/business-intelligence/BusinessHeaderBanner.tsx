...
import { Building2, TrendingUp, Layers, PieChart, ShieldCheck, Zap, ArrowDownRight, Compass } from 'lucide-react';
...
export function BusinessHeaderBanner({
  totalCompanies,
  totalIndustries,
  totalDeals,
  totalExecutives,
  totalNews,
}: BusinessHeaderBannerProps) {
        ...
        <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-8 relative z-10">
          <div className="space-y-4 max-w-3xl">
            <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-amber-500/10 border border-amber-500/25 text-amber-400 text-xs font-mono font-bold uppercase tracking-widest">
              ...
              <span>AiX Business Intelligence Terminal</span>
            </div>
            ...
            <div className="space-y-1">
              ...
              <p className="text-lg sm:text-xl font-serif text-amber-300/90 font-medium">
                Romania&apos;s companies, industries, capital and business intelligence.
              </p>
            </div>

            <p className="text-sm sm:text-base text-neutral-300 font-serif leading-relaxed max-w-2xl">
              Platformă instituțională de analiză corporativă: clasamentul companiilor, monitorul tranzacțiilor M&amp;A, profiluri de executivi și radarul mișcărilor strategice din economia românească.
            </p>
          </div>

          {/* Quick Summary Grid Badges */}
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-3 shrink-0 lg:w-80">
            <div className="p-3.5 rounded-2xl bg-neutral-950/80 border border-neutral-800/90 backdrop-blur-md space-y-1">
              <div className="text-[10px] font-mono uppercase text-neutral-400 flex items-center gap-1">
                <Building2 className="w-3 h-3 text-amber-400" />
                <span>Companies</span>
              </div>
              <div className="text-xl font-mono font-bold text-white">{totalCompanies} Lideri</div>
            </div>
            ...
            <div className="p-3.5 rounded-2xl bg-neutral-950/80 border border-neutral-800/90 backdrop-blur-md space-y-1">
              ...
              <div className="text-xl font-mono font-bold text-white">{totalIndustries} Sectoare</div>
            </div>
            ...
            <div className="p-3.5 rounded-2xl bg-neutral-950/80 border border-neutral-800/90 backdrop-blur-md space-y-1">
              ...
              <div className="text-xl font-mono font-bold text-white">{totalDeals} M&amp;A</div>
            </div>
            ...
            <div className="p-3.5 rounded-2xl bg-neutral-950/80 border border-neutral-800/90 backdrop-blur-md space-y-1">
              ...
              <div className="text-xl font-mono font-bold text-white">{totalExecutives} Lideri</div>
            </div>

            <div className="p-3.5 rounded-2xl bg-neutral-950/80 border border-neutral-800/90 backdrop-blur-md space-y-1 col-span-2 sm:col-span-2">
              <div className="text-[10px] font-mono uppercase text-neutral-400 flex items-center gap-1">
                <PieChart className="w-3 h-3 text-amber-400" />
                <span>Intelligence Feed</span>
              </div>
              <div className="text-sm font-mono font-bold text-neutral-200">
                {totalNews} Rapoarte Verificate
              </div>
            </div>
          </div>
        </div>

        {/* Sticky Terminal Navigation Anchor Tabs */}
