...
import { Activity, TrendingUp, Compass, ArrowDownRight, Globe2, ShieldCheck, Zap } from 'lucide-react';

export function MarketsHeaderBanner() {
      ...
      <div className="rounded-3xl bg-gradient-to-br from-neutral-950 via-neutral-900 to-amber-950/40 p-6 md:p-10 border border-neutral-800 shadow-2xl relative overflow-hidden">
        ...
        <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-8 relative z-10">
          <div className="space-y-4 max-w-3xl">
            <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-amber-500/10 border border-amber-500/25 text-amber-400 text-xs font-mono font-bold uppercase tracking-widest">
              ...
              <span>AiX Markets Intelligence Terminal</span>
            </div>
            ...
            <div className="space-y-1">
              ...
              <p className="text-lg sm:text-xl font-serif text-amber-300/90 font-medium">
                Cotații Oficiale BVB &amp; Indici Globali, Indicatori Macroeconomici, Rate Bănci Centrale &amp; Mărfuri.
              </p>
            </div>

            <p className="text-sm sm:text-base text-neutral-300 font-serif leading-relaxed max-w-2xl">
              Platformă instituțională de analiză a piețelor financiare: indicii bursieri BET &amp; globali, tabloul macroeconomic al României (INS/BNR), curba de randament a titlurilor de stat și analiza pe sectoare.
            </p>
          </div>

          {/* Quick Terminal Counters */}
          <div className="grid grid-cols-2 gap-3 shrink-0 lg:w-80 font-mono text-xs">
            <div className="p-3.5 rounded-2xl bg-neutral-950/80 border border-neutral-800 space-y-1">
              <div className="text-[10px] text-neutral-400 uppercase flex items-center gap-1">
                ...
                <span>Indice BET (BVB)</span>
              </div>
              <div className="text-xl font-bold text-white">18,450.2</div>
              <div className="text-[10px] text-emerald-400 font-semibold">+14.8% YTD</div>
            </div>
            ...
            <div className="p-3.5 rounded-2xl bg-neutral-950/80 border border-neutral-800 space-y-1">
              ...
              <div className="text-xl font-bold text-white">4.9750</div>
              <div className="text-[10px] text-neutral-400">Curs BNR Oficial</div>
            </div>

            <div className="p-3.5 rounded-2xl bg-neutral-950/80 border border-neutral-800 space-y-1">
              <div className="text-[10px] text-neutral-400 uppercase flex items-center gap-1">
                <TrendingUp className="w-3 h-3 text-sky-400" />
                <span>Dobândă BNR</span>
              </div>
              <div className="text-xl font-bold text-amber-400">6.50%</div>
              <div className="text-[10px] text-neutral-400">Politică Monetară</div>
            </div>

            <div className="p-3.5 rounded-2xl bg-neutral-950/80 border border-neutral-800 space-y-1">
              <div className="text-[10px] text-neutral-400 uppercase flex items-center gap-1">
                <ShieldCheck className="w-3 h-3 text-purple-400" />
                <span>Inflație IPC</span>
              </div>
              <div className="text-xl font-bold text-emerald-400">4.80%</div>
              <div className="text-[10px] text-emerald-400 font-semibold">-0.10% MoM</div>
            </div>
          </div>
        </div>
        ...
        <div className="mt-8 pt-6 border-t border-neutral-800/80 overflow-x-auto no-scrollbar">
          <div className="flex items-center gap-2 min-w-max">
            ...
            {[
              { id: 'global-indices', label: 'Global & BVB Indices' },
              { id: 'movers', label: 'Market Movers' },
              { id: 'romania-macro', label: 'Romania Macro' },
              { id: 'central-banks', label: 'Central Banks & Bonds' },
              { id: 'fx-commodities', label: 'FX & Commodities' },
              { id: 'sectors-risk', label: 'Sectors & Risk Monitor' },
