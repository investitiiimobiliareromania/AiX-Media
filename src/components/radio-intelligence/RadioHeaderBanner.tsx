...
export function RadioHeaderBanner({
  totalStations,
  searchQuery,
  onSearchChange,
  selectedCategory,
  onCategoryChange,
}: RadioHeaderBannerProps) {
  const categories = [
    { id: 'all', label: 'Toate Stațiile' },
        ...
        <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-8 relative z-10">
          <div className="space-y-4 max-w-3xl">
            <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-amber-500/10 border border-amber-500/25 text-amber-400 text-xs font-mono font-bold uppercase tracking-widest">
              ...
              <span>AiX Live Audio Intelligence Hub</span>
            </div>
            ...
            <div className="space-y-1">
              ...
              <p className="text-lg sm:text-xl font-serif text-amber-300/90 font-medium">
                Live Business, Monetary Policy &amp; Financial Markets Audio Streams.
              </p>
            </div>

            <p className="text-sm sm:text-base text-neutral-300 font-serif leading-relaxed max-w-2xl">
              Hub-ul audio live de business și economie: fluxuri radio naționale verificate, jurnale de știri economice, transmisiuni BNR și emisiuni de analiză corporativă.
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 gap-3 shrink-0 lg:w-72 font-mono text-xs">
            <div className="p-4 rounded-2xl bg-neutral-950/80 border border-neutral-800 space-y-1">
              <div className="text-[10px] text-neutral-400 uppercase">Stații Live</div>
              <div className="text-2xl font-bold text-white">{totalStations} Radio</div>
            </div>

            <div className="p-4 rounded-2xl bg-neutral-950/80 border border-neutral-800 space-y-1">
              <div className="text-[10px] text-neutral-400 uppercase">Stream Audio</div>
              <div className="text-2xl font-bold text-emerald-400">100% Real Live</div>
            </div>
          </div>
        </div>
        ...
        <div className="mt-8 pt-6 border-t border-neutral-800/80 grid grid-cols-1 md:grid-cols-12 gap-3 font-mono text-xs">
          <div className="relative md:col-span-6">
            <input
              ...
              placeholder="Caută după stație radio, oraș, gen sau frecvență..."
