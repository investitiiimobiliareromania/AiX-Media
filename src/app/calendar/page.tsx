...
export default function CalendarPage() {
  ...
  return (
    <div className="space-y-8 pb-16 pt-4 text-neutral-100">
      ...
      <section id="events" className="p-6 md:p-8 rounded-2xl bg-[#111317] border border-[#262932] space-y-6 shadow-xl">
        ...
        <div className="overflow-x-auto bg-[#171920] rounded-xl border border-[#262932] shadow-xs">
          <table className="w-full text-left border-collapse font-mono text-xs text-neutral-300">
            <thead>
              <tr className="border-b border-[#262932] text-neutral-400 bg-[#111317] uppercase text-[10px] tracking-wider">
            ...
            <tbody className="divide-y divide-[#262932]">
              {events.map((ev) => (
                <tr key={ev.id} className="hover:bg-[#1f222b] transition-colors">
                    ...
                    <span
                      className={`px-2 py-0.5 rounded text-[9px] font-bold ${
                        ev.importance === "HIGH"
                          ...
                          : "bg-[#1f222b] text-neutral-300 border border-[#262932]"
                      }`}
                    >
                      {ev.importance}
                    </span>
