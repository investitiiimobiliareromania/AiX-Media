...
export default function GdprPage() {
  return (
    <section className="max-w-4xl mx-auto py-12 px-4 sm:px-6 lg:px-8 text-neutral-100 space-y-6">
      <h1 className="font-serif text-3xl font-bold text-white border-b border-[#262932] pb-4">Conformitate GDPR</h1>
      ...
      <div className="bg-[#111317] border border-[#262932] rounded-2xl p-6 font-mono text-xs text-neutral-300 space-y-2 shadow-lg">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 my-6">
        <div className="p-5 rounded-2xl bg-[#111317] border border-[#262932] space-y-2 shadow-md">
      ...
      <div className="pt-6 border-t border-[#262932] flex gap-4 text-xs font-mono">
