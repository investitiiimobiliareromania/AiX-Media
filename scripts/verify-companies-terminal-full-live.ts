...
async function verifyCompaniesFullLive() {
  console.log('=== FORENSIC LIVE QA: CORPORATE & COMPANIES INTELLIGENCE TERMINAL ===\n');
  ...
  const url = 'https://aixmedia.cristianvaduva.com/companies';
  ...
  console.log(`     Search Enabled   : ${audit.searchInput ? 'YES' : 'NO'}`);
  console.log(`     Leaderboard Rows : ${audit.tableRows}`);
...
verifyCompaniesFullLive().catch(console.error);
